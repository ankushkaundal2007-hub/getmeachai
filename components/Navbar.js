      ...
      <nav className='flex justify-between items-center px-4  bg-blue-950 text-white h-14'>
        ...
        <div className="login-button gap-3 flex relative">
          {session && (<>
            ...
            <div id="dropdown" className={`z-10 ${showdrop ? " " : "hidden"} absolute  top-full mt-4 bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-44`}>
